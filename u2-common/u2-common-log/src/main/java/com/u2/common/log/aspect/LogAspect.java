package com.u2.common.log.aspect;
...
import com.u2.common.log.enums.BusinessStatus;
import com.u2.common.log.filter.PropertyPreExcludeFilter;
import com.u2.common.log.service.AsyncLogService;
            ...
            for (Object o : paramsArray) {
                if (StringUtils.isNotNull(o) && !isFilterObject(o)) {
                    try {
                        ...
                        System.out.println("w:toJSONString error");
                    }
                }
            }
        }
